...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12|GPIO_Pin_13;	  //PA1->IIC_SCL  PA2->IIC_SDA
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD; 		    //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;       //速度50MHz
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	                //初始化PA1,PA2
 	GPIO_SetBits(GPIOB,GPIO_Pin_12|GPIO_Pin_13);              //PA1,PA2置高
